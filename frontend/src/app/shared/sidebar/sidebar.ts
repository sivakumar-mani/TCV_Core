...
export class Sidebar {
  ...
  readonly groups = [
    { label: 'Business Partners', icon: 'groups', items: [['CCTV Customer', '/customers', 'CUSTOMERS'], ['Cable TV Customers', '/cable-tv/customers', 'CABLE_TV_CUSTOMERS'], ['Suppliers', '/suppliers', 'SUPPLIERS']] },
