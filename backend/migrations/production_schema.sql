-- TCV Core production schema
-- Generated from the current local tcvonedb structure. Contains no application data.
-- Generated: 2026-08-18T07:34:07.928Z
SET NAMES utf8mb4;
...
-- Table: cable_connection_materials
...
-- Table: cable_connection_sources
...
-- Table: cable_customer_account_payments
...
-- Table: cable_customer_stb_accessories
...
-- Table: cable_subscription_payments
...
-- Table: cable_tv_complaint_attempts
...
CREATE TABLE `cable_tv_customers` (
  ...
  `recharge_amount` decimal(12,2) NOT NULL DEFAULT '0.00',
  ...
  `installed_by_employee_id` int DEFAULT NULL,
  `labour_service_charge` decimal(12,2) NOT NULL DEFAULT '0.00',
  `status` enum('ACTIVE','INACTIVE','DISCONNECTED','SHIFTED','TRANSFERRED','RETRIEVED','FAULT','UPGRADE','FREE','LEASE_LINE') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ACTIVE',
  `approval_status` enum('PENDING','APPROVED','REJECTED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
  `created_by_user_id` int DEFAULT NULL,
  `approved_by_user_id` int DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
...
-- Table: internet_connection_materials
...
-- Table: internet_customer_account_payments
...
-- Table: internet_customer_accounts
...
-- Table: internet_customer_complaints
...
-- Table: internet_customer_packages
...
-- Table: internet_customer_routers
...
CREATE TABLE `internet_customers` (
  ...
  `customer_code` int NOT NULL,
  `legacy_customer_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_internet_legacy_customer_no` (`legacy_customer_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: internet_subscriptions
CREATE TABLE `internet_subscriptions` (
  ...
  `payment_reference` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_mapped_employee_id` int DEFAULT NULL,
  `cash_admin_locked` tinyint(1) NOT NULL DEFAULT '0',
...
-- Table: technician_material_movements
...
-- Table: technician_material_sale_payments
...
-- Table: technician_material_stock
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='User authentication and role management';

-- Table: warranty_master
...
-- Table: work_order_material_issues
...
-- Table: work_order_material_returns
