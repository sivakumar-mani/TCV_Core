...
CREATE TABLE employees (
    ...
    employee_code VARCHAR(50) NOT NULL UNIQUE COMMENT 'Unique employee identifier',
    ...
    photo VARCHAR(255) COMMENT 'Photo file path or URL',
    ...
    id_proof_type VARCHAR(100) COMMENT 'Type of identification proof',
    ...
    salary DECIMAL(12,2) NOT NULL DEFAULT 0 CHECK (salary >= 0),
    address TEXT,
    city VARCHAR(100),
    state VARCHAR(100),
    pincode VARCHAR(10),
