...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Groups Cable TV records for single workflow approval. New customer onboarding uses one group for customer, STB, connection, materials, package and subscription.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV area master mapped to location';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materials used for Cable TV connection, entered as add-row items';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV source of connection master';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV connection, disconnection, shifted and transferred history';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV package assigned to customer with snapshot package price';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Customer STB details and exchange history';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV location master';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV network master: TCV, PAMMAL, MURUGAN, SVN';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV package master with package type and price';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV street master mapped to area';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cable TV monthly/yearly subscription billing and collection';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cable_tv_customers` (
  ...
  `customer_type` enum('REGULAR','BUSINESS','FREE','LEASE_LINE') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'REGULAR',
  `topup_base_amount` decimal(12,2) NOT NULL DEFAULT '0.00',
  `topup_gst_percent` decimal(5,2) NOT NULL DEFAULT '18.00',
  `legacy_customer_no` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `network_customer_no` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Combined Cable TV customer table for all networks';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='User authentication and role management';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,NULL,NULL,'admin','Tcv@1310','admin@tcv.local',NULL,'Admin',NULL,'ADMIN',1,'2026-08-13','2026-08-13 11:49:19',0,NULL,'2026-08-13 04:47:09','2026-08-13 06:19:19');
...
-- Dump completed on 2026-08-13 12:11:09
